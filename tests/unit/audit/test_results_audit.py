...
from datp.audit.schemas import RunManifestRecord, WarningRecord
...
def test_results_audit_generates_seed_deltas(tmp_path: Path) -> None:
    from datp.audit.constants import SEED_DELTAS_CSV
...
def test_results_audit_generates_regime_c_alpha_csv(tmp_path: Path) -> None:
    from datp.audit.constants import REGIME_C_ALPHA_AUDIT_CSV
...
def test_flat_cv_tpr_warning_emitted() -> None:
    from datp.audit.results import _emit_flat_cv_tpr_warnings
...
def test_worst_client_stability_warning_when_always_same() -> None:
    from datp.audit.results import _emit_worst_client_stability_warnings
    from datp.audit.schemas import WorstClientRecord
...
def test_results_audit_fpr_companion_has_required_columns(tmp_path: Path) -> None:
    from datp.audit.constants import FPR_COMPANION_METRICS_CSV
...
def test_results_audit_generates_metric_recomputation_csv(tmp_path: Path) -> None:
    from datp.audit.constants import METRIC_RECOMPUTATION_AUDIT_CSV
