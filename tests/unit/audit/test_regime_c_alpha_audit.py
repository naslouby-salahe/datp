...
from datp.audit.datasets import build_regime_c_alpha_audit
from datp.audit.schemas import RegimeCAlphaAuditRecord
...
class TestRegimeCSeverityTrend:
    from datp.audit.datasets import compute_regime_c_severity_trend
    from datp.audit.schemas import RegimeCAlphaAuditRecord
...
class TestEnrichRegimeCRecordsWithCv:
    ...
    def test_populates_cv_fpr_from_cell_panel(self) -> None:
        from datp.audit.results import _CellPanel, _enrich_regime_c_records_with_cv
    ...
    def test_missing_panel_entries_leave_fields_none(self) -> None:
        from datp.audit.results import _enrich_regime_c_records_with_cv
...
class TestB4StabilityFromClusterRecords:
    def test_empty_returns_empty(self) -> None:
        from datp.audit.results import _b4_stability_from_cluster_records

        assert _b4_stability_from_cluster_records([]) == []

    def test_single_seed_returns_empty(self) -> None:
        from datp.audit.results import _b4_stability_from_cluster_records
        from datp.audit.schemas import ClusterAssignmentRecord
