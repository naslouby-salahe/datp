...
from datp.training.protocols.fedrep import DatpFedRepClient, run_fedrep_training
from datp.training.scoring import ClientData, score_fedrep_clients
...
class TestFedRepClient:
    ...
    def test_fit_trains_and_returns_encoder_only(self, tmp_path: Path) -> None:
        from datp.training.parameters import get_parameters
    ...
    def test_not_labeled_ditto(self) -> None:
        ...
        import datp.training.protocols.fedrep as fedrep_module
...
class TestRunFedRepTraining:
    ...
    def test_produces_per_client_score_files(self, tmp_path: Path) -> None:
        from datp.artifacts.constants import PARQUET_SUFFIX
        from datp.training.simulation import TrainingResult
        import datp.training.protocols.fedrep as fedrep_mod
