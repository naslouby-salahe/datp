...
from datp.analyses.threshold_shift import ThresholdShiftRow, ThresholdShiftResult, run_threshold_shift
...
def _make_manifest(cell_dir: Path, ckpt_path: str) -> dict:
    return {
        ...
        "model_checkpoint_path": ckpt_path, "model_checkpoint_hash": "abc",
...
class TestThresholdShiftRow:
    def test_schema_frozen(self):
        row = ThresholdShiftRow(
            client_id="d1", tau_b1=0.1, tau_b2=0.08, shift=-0.02,
            fpr_b1=0.05, fpr_b2=0.02, delta_fpr=0.03,
            tpr_b1=0.9, tpr_b2=0.88, delta_tpr=-0.02, seed=0, device_family="camera",
        )
