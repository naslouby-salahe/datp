...
\end{equation}
aggregated over seeds $s \in \mathcal{S}$ via a bootstrap stability interval (95\%, $n=10{,}000$ resamples of the five seed-level deltas).
With only five seeds, this interval is a seed-level consistency summary---not a high-powered
population significance test.
We interpret all-positive seed deltas with an interval excluding zero as seed-level support
