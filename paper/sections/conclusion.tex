...
client. Practically, B2 should be considered when a shared-threshold pilot shows high
relative FPR dispersion (e.g., CV(FPR) near or above~1 with full coverage); B4 is a
taxonomy-free alternative when fingerprint leakage is acceptable.
