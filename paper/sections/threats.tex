...
\textbf{Privacy.}
B4's fingerprint constitutes distributional metadata leakage; B4 is not a privacy mechanism. Mitigations (secure aggregation, differential privacy) are future work.
...
synchronized encoder; they should not be read as evidence that the same magnitude holds under drift-heavy settings with larger $E$ or partial participation ($E>1$ is future sensitivity work).
