...
generally.
Chronological or physical-device CICIoT2023 partitions remain future work.
...
with frequent aggregation, intentionally limiting local weight drift.
Our results therefore characterize threshold-scope personalization under a frequently
synchronized FedAvg encoder; they should not be read as evidence that the same
improvement magnitude necessarily holds under drift-heavy FedAvg deployments with
larger local epochs or partial participation.
