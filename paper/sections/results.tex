...
\begin{table}[t]
  ...
  \begin{tabular}{p{1.5cm}p{1.6cm}p{2.0cm}p{2.1cm}}
    \toprule
...
\begin{table}[t]
  ...
  \begin{tabular}{@{}llccc c@{}}
    ...
    \midrule
    B1 & Arith.\ mean & $1.017{\scriptstyle\pm.019}$ & $.035{\scriptstyle\pm.002}$ & $.120{\scriptstyle\pm.007}$ & $+.718$ \\
    B1-pool & Pooled $p_{95}$ & $0.805{\scriptstyle\pm.048}$ & $.084{\scriptstyle\pm.007}$ & $.134{\scriptstyle\pm.012}$ & $+.506$ \\
    B1-wt & Wt.\ mean & $0.907{\scriptstyle\pm.033}$ & $.050{\scriptstyle\pm.018}$ & $.129{\scriptstyle\pm.003}$ & $+.608$ \\
    B2 & Per-client $p_{95}$ & $0.299{\scriptstyle\pm.073}$ & $.015{\scriptstyle\pm.003}$ & $.041{\scriptstyle\pm.012}$ & --- \\
    \bottomrule
  \end{tabular}
  \par\vspace{3pt}
...
\begin{table}[t]
  ...
  \begin{tabular}{@{}lcccccc@{}}
    \toprule
    Baseline & FPR & TPR & CV(FPR) & CV(TPR) & Worst~BA & Mean~F1 \\
    \midrule
    B0 (Centr.)  & $.051{\scriptstyle\pm.001}$ & $.981{\scriptstyle\pm.000}$ & $.109{\scriptstyle\pm.020}$ & $.001{\scriptstyle\pm.000}$ & $.954{\scriptstyle\pm.006}$ & $.959{\scriptstyle\pm.000}$ \\
    B1 (Avg.)    & $.051{\scriptstyle\pm.001}$ & $.982{\scriptstyle\pm.000}$ & $.099{\scriptstyle\pm.002}$ & $.001{\scriptstyle\pm.000}$ & $.959{\scriptstyle\pm.002}$ & $.959{\scriptstyle\pm.000}$ \\
    B2 (Per-Cl.) & $.051{\scriptstyle\pm.001}$ & $.982{\scriptstyle\pm.000}$ & $.133{\scriptstyle\pm.007}$ & $.001{\scriptstyle\pm.000}$ & $.956{\scriptstyle\pm.001}$ & $.959{\scriptstyle\pm.000}$ \\
    B4 (Clust.)  & $.051{\scriptstyle\pm.001}$ & $.982{\scriptstyle\pm.000}$ & $.101{\scriptstyle\pm.003}$ & $.001{\scriptstyle\pm.000}$ & $.959{\scriptstyle\pm.002}$ & $.959{\scriptstyle\pm.000}$ \\
    \bottomrule
  \end{tabular}
  \vspace{-2pt}
\end{table}
...
\begin{table}[t]
  ...
  \begin{tabular}{@{}l c c c c l@{}}
    ...
    \midrule
    0.1  & $.779{\scriptstyle\pm.104}$ & $.134{\scriptstyle\pm.025}$ & $.531{\scriptstyle\pm.103}$ & $0.645$ & $[0.535,\,0.786]$ \\
    0.3  & $.793{\scriptstyle\pm.178}$ & $.117{\scriptstyle\pm.028}$ & $.561{\scriptstyle\pm.184}$ & $0.677$ & $[0.420,\,0.897]$ \\
    0.5  & $.636{\scriptstyle\pm.197}$ & $.117{\scriptstyle\pm.014}$ & $.436{\scriptstyle\pm.063}$ & $0.519$ & $[0.240,\,0.777]$ \\
    1.0  & $.544{\scriptstyle\pm.116}$ & $.096{\scriptstyle\pm.021}$ & $.426{\scriptstyle\pm.066}$ & $0.448$ & $[0.238,\,0.565]$ \\
    10.0 & $.174{\scriptstyle\pm.053}$ & $.111{\scriptstyle\pm.016}$ & $.133{\scriptstyle\pm.012}$ & $0.063$ & $[0.006,\,0.122]$ \\
    IID  & $.074{\scriptstyle\pm.014}$ & $.100{\scriptstyle\pm.015}$ & $.075{\scriptstyle\pm.013}$ & $-0.026$ & $[-0.032,\,-0.019]$ \\
    \bottomrule
  \end{tabular}
  \par\vspace{3pt}
