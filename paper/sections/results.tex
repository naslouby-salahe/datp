\begin{table*}[!t]
  ...
  \begin{tabular*}{\textwidth}{@{\extracolsep{\fill}}lccccccc}
    ...
    B4 (Cluster-Mean) & $0.044\pm0.003$ & $0.718\pm0.019$ & $0.645\pm0.045$ & $0.322\pm0.012$ & $0.654\pm0.007$ & $0.545\pm0.036$ & $0.299\pm0.000$ \\
	  ...
	  \end{tabular*}
		  \par\vspace{2pt}
		  \parbox{\textwidth}{\scriptsize Coverage 9/9, pending 0. Values are mean $\pm$ std over 5 seeds. B0 is a centralized reference and is excluded from the B1--B4 controlled ladder. Worst BA = worst-client balanced accuracy; mean F1 = mean Macro-F1; P10 F1 = 10th-percentile Macro-F1 across eligible clients.}
		  \par\vspace{1pt}
		  \parbox{\textwidth}{\scriptsize Primary result: \textbf{B1$-$B2 CV(FPR) $\boldsymbol{\Delta = +0.718}$}, SD$\,{=}\,0.079$, seed range $[0.588,\,0.772]$, all 5 deltas positive; B1$-$B4 $\Delta = +0.372$, SD$\,{=}\,0.055$, seed range $[0.319,\,0.443]$.}
  \endgroup
\end{table*}
