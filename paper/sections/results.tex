...
Its value lies in deployments where per-client state is unavailable and operators need a
taxonomy-free intermediate policy---at the cost of distributional metadata leakage.
