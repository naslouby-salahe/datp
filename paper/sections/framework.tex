...
\begin{figure}[t]
  ...
  \caption{Per-device FPR under B1 (Client-Averaged Shared~$\tau$) and B2 (Per-Client~$\tau$)
           for the nine N-BaIoT clients (seed~0; illustrative preview).
           Multi-seed inference uses the aggregate results in Table~\ref{tab:regime_a}.}
...
Bootstrap CIs are computed over seed-level deltas.
