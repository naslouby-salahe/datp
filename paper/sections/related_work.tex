...
methods such as pFedMe, Per-FedAvg, and FedPer modify model weights or training
...
\begin{table}[t]
  ...
  \begin{tabular}{lll}
    ...
    pFedMe, FedPer~\cite{fallah2020personalized,arivazhagan2019federated} & Model weights/objectives & Not addressed \\
