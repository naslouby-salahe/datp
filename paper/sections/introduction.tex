...
\begin{itemize}
  ...
  \item Held-out measurement on N-BaIoT of the expected per-client calibration effect: B2
        reduces CV(FPR) from $\approx 1.02$ (B1) to $0.299$
        ($\Delta = 0.718$, SD$\,{=}\,0.079$, range $[0.588,\,0.772]$, all five seed deltas positive).
        The detection-quality cost---mean Macro-F1 improves but lower-tail P10 Macro-F1
        worsens, concentrated in a low-separability client---is characterized alongside the FPR-equity gain.
