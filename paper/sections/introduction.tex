...
We ask how large the per-client FPR disparity is under a shared threshold,
...
\textbf{Contributions.}
\begin{itemize}
  \item A controlled threshold-calibration study in which the FedAvg AE ($E{=}1$, full participation),
  ...
  \item Empirical evidence on N-BaIoT that the client-averaged shared threshold (B1) yields
        ...
        ($\Delta = 0.718$, SD$\,{=}\,0.079$, range $[0.588,\,0.772]$, all five seed deltas positive).
        The detection-quality tradeoff---mean Macro-F1 improves but lower-tail P10 Macro-F1
        worsens, concentrated in a low-separability client---is characterized and should be weighed against the FPR-equity gain.
