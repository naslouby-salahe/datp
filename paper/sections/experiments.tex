...
CICIoT2023~\cite{neto2023ciciot2023} provides 63 file-defined pseudo-clients under our partition.
...
training with frequent aggregation; we retain the FedAvg framing for consistency with
...
The primary statistic is the seed-level bootstrap stability interval (95\%,
$n_{\text{bootstrap}} = 10{,}000$ resamples) over $\{\Delta_s\}_{s \in \{0,\ldots,4\}}$.
With only five seed-level deltas, this interval quantifies seed-to-seed consistency
rather than high-powered population inference; we use it as a stability summary,
not as a confirmatory significance test.
...
\begin{table}[t]
  ...
  \begin{tabular}{p{0.9\columnwidth}}
    ...
    Nominal test fraction~$= 0.18$; gap buffers excluded from all partitions. \\
