...
The nine devices comprise two doorbells, a thermostat, a baby monitor, a webcam,
and four security cameras.
...
With only five seeds, reporting relies on seed-level descriptive summaries:
mean, standard deviation, range, and sign consistency.
...
Table~\ref{tab:regimes} summarizes the three regimes; the full reproducibility
specification appears in Table~\ref{tab:repro}.
